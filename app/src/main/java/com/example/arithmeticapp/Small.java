...
public class Small extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt1=(AppCompatButton) findViewById(R.id.small);
        ...
        bt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    if (n1>n2)
                    {
                        Toast.makeText(getApplicationContext(),String.valueOf(n2)+" is the smallest number",Toast.LENGTH_LONG).show();
                    }
                    else
                    {
                        Toast.makeText(getApplicationContext(),String.valueOf(n1)+" is the smallest number",Toast.LENGTH_LONG).show();
                    }
                }
                catch (Exception e)
                {
